...
class DersDetay extends StatefulWidget {
  ...
  })  : ilisikili_oldugu_program_ciktilari = ilisikili_oldugu_program_ciktilari?.cast<int>(),
        super(key: key);
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 20),
                            state.role != 'Öğretim elemanı' ?Matris(Lesson(
                                ...
                                verildigi_bolum: '',
                                verildigi_donem: '',
                                ilisikili_oldugu_program_ciktilari: widget.ilisikili_oldugu_program_ciktilari!))
                            : EditableMatrix(lesson: Lesson(
                                docId: widget.docID,
                                ders_adi: widget.ders_adi,
                                ders_kodu: widget.ders_kodu,
                                ogretim_elemani: widget.ogretim_elemani!,
