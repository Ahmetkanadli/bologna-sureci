...
class AnonimOgretimPlani extends StatefulWidget {
  const AnonimOgretimPlani({
    super.key,
  ...
  @override
  State<AnonimOgretimPlani> createState() => _AnonimOgretimPlaniState();
}

class _AnonimOgretimPlaniState extends State<AnonimOgretimPlani> {
  ...
  Widget _buildDonemSection(String title, List<Lesson> lessons) {
    return ExpansionTile(
      ...
      children: lessons.map((lesson) {
        return lesson.verildigi_bolum == widget.fakulte_adi ? ListTile(
